    ...
    def __init__(self, **kwargs):
        ...
        self['connec_body'] = kwargs.pop('connec_body', 
                                    [[11, 0, self['weigths_body'], self['phi_contra_body']], [0, 11, self['weigths_body'], self['phi_contra_body']],
                                     ...
                                     [2, 1, self['weigths_body'], self['phi_up_body']], [1, 2, self['weigths_body'], self['phi_down_body']], 
                                     [13, 12, self['weigths_body'], self['phi_up_body']], [12, 13, self['weigths_body'], self['phi_down_body']],
                                     ...
                                     [7, 6, self['weigths_body'], self['phi_up_body']], [6, 7, self['weigths_body'], self['phi_down_body']],
                                     [18, 17, self['weigths_body'], self['phi_up_body']], [17, 18, self['weigths_body'], self['phi_down_body']],
        ...
        self['connec_left_forelimb'] = kwargs.pop('connec_left_forelimb', [[22, 25, self['weigths_limb'], self['phi_shoulder_contra']],             
                                                                           ...
                                                                           [24, 27, self['weigths_limb'], 0], 
                                                                           [27, 24, self['weigths_limb'], 0]])
        self['connec_right_forelimb'] = kwargs.pop('connec_right_forelimb', [[28, 31, self['weigths_limb'], self['phi_shoulder_contra']], 
                                                                             ...
                                                                             [30, 33, self['weigths_limb'], 0], 
                                                                             [33, 30, self['weigths_limb'], 0]])
        self['connec_left_hindlimb'] = kwargs.pop('connec_left_hindlimb', [[37, 34, self['weigths_limb'], self['phi_shoulder_contra']], 
                                                                           ...
                                                                           [38, 37, self['weigths_limb'], self['phi_shoulder_up']], 
                                                                           [37, 38, self['weigths_limb'], self['phi_shoulder_down']],
                                                                           ...
                                                                           [39, 36, self['weigths_limb'], 0], 
                                                                           [36, 39, self['weigths_limb'], 0]])
        self['connec_right_hindlimb'] = kwargs.pop('connec_right_hindlimb', [[43, 40, self['weigths_limb'], self['phi_shoulder_contra']], 
                                                                             ...
                                                                             [41, 40, self['weigths_limb'], self['phi_shoulder_up']], 
                                                                             [40, 41, self['weigths_limb'], self['phi_shoulder_down']],
                                                                             [44, 43, self['weigths_limb'], self['phi_shoulder_up']], 
                                                                             [43, 44, self['weigths_limb'], self['phi_shoulder_down']],
                                                                             ...
                                                                             [45, 42, self['weigths_limb'], 0], 
                                                                             [42, 45, self['weigths_limb'], 0]])
        ...
        self['connec_body_left_forelimb'] = kwargs.pop('connec_body_left_forelimb', [[22, 1, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                     [1, 22, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                     [25, 1, self['weights_limb_to_body'], 0], 
                                                                                     [1, 25, self['weights_limb_to_body'], 0]])
        self['connec_body_right_forelimb'] = kwargs.pop('connec_body_right_forelimb',[[12, 28, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                      [28, 12, self['weights_limb_to_body'], self['phi_limb_to_body']],
                                                                                      [12, 31, self['weights_limb_to_body'], 0], 
                                                                                      [31, 12, self['weights_limb_to_body'], 0]])
        self['connec_body_left_hindlimb'] = kwargs.pop('connec_body_left_hindlimb',[[4, 34, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                    [34, 4, self['weights_limb_to_body'], self['phi_limb_to_body']],
                                                                                    [4, 37, self['weights_limb_to_body'], 0], 
                                                                                    [37, 4, self['weights_limb_to_body'], 0]])
        self['connec_body_right_hindlimb'] = kwargs.pop('connec_body_right_hindlimb',[[15, 40, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                      [40, 15, self['weights_limb_to_body'], self['phi_limb_to_body']], 
                                                                                      [15, 43, self['weights_limb_to_body'], 0], 
