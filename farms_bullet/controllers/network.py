...
#     def __init__(self, ode, n_osc):
#         super(SalamanderNetwork, self).__init__()
#         self._ode = ode
#         self._n_oscillators = n_osc
...
#         """Network for walking"""
#         network_ode = SalamanderNetworkODE.walking(
#             timestep,
#             phases,
#             amplitude
#         )
#         return cls(network_ode)

#     @classmethod
#     def swimming(cls, timestep, phases=None, amplitude=None):
#         """Network for """
#         network_ode = SalamanderNetworkODE.swimming(
#             timestep,
#             phases,
#             amplitude
#         )
...
#         # )
#         # self._ode_amplitude.control_step()
#         # return self._ode.control_step(freqs)
#         return self._ode.control_step(freqs)

#     @property
#     def phases(self):
#         """Oscillators phases"""
#         return self._ode.state[:self._n_oscillators]

#     @property
#     def dphases(self):
#         """Oscillators phases velocity"""
#         return self._ode.dstate[:self._n_oscillators]
...
#     def __init__(self, ode, offsets):
#         super(SalamanderNetworkPosition, self).__init__(ode)
...
#     @classmethod
#     def pos_walking(cls, timestep, phases=None, amplitude=None):
#         """Network for walking"""
...
#                         options["leg_{}_amplitude".format(i)]
#                     )
#         ode = SalamanderNetworkODE.walking(
#             timestep,
#             phases,
